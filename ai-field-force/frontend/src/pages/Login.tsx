...
import { is2FAResponse } from '../types';import { getErrorMessage } from '../api/client';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-forest-50 dark:bg-forest-950 flex flex-col items-center justify-center px-4 py-10 relative">
      {/* Top-right language picker */}
      <div className="absolute top-4 right-4 z-30">
        <div className="relative">
          <button
            onClick={() => setLangOpen((p) => !p)}
            className="h-9 px-3 rounded-lg flex items-center justify-center hover:bg-white dark:hover:bg-forest-800 text-forest-700 dark:text-forest-300 text-xs font-bold transition-colors border border-forest-200 dark:border-forest-700 bg-white/80 dark:bg-forest-900/80 backdrop-blur"
      ...
      <div className="mb-8 text-center">
        ...
        <h1 className="font-display text-2xl font-bold text-forest-900 dark:text-white">{t('auth.title')}</h1>
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex rounded-xl bg-white dark:bg-forest-900 border border-forest-100 dark:border-forest-800 p-1 mb-6 shadow-card">
          <button
            ...
            className={`flex-1 rounded-lg py-2 text-xs font-semibold transition-colors ${
              mode === 'password' ? 'bg-forest-700 text-white' : 'text-sage-500 hover:text-forest-700 dark:hover:text-forest-300'
            }`}
          >
            {t('auth.tab.password')}
          </button>
          <button
            ...
            className={`flex-1 rounded-lg py-2 text-xs font-semibold transition-colors ${
              mode === 'otp-phone' || mode === 'otp-code' ? 'bg-forest-700 text-white' : 'text-sage-500 hover:text-forest-700 dark:hover:text-forest-300'
            }`}
          >
            {t('auth.tab.otp')}
          </button>
        ...
        <div className="card p-6 space-y-4 shadow-card-lg">
          ...
          <div className="flex items-center gap-3 py-1">
            <div className="flex-1 h-px bg-forest-100 dark:bg-forest-800" />
        ...
        <div className="mt-4 card p-4 border-parchment-300 bg-parchment-50">
          <p className="text-xs font-semibold text-forest-800 mb-2">{t('auth.demo')}</p>
          <div className="space-y-1">
            ...
            <p className="text-xs text-sage-600"><span className="font-medium text-forest-700">OTP:</span> 9999999999</p>
          </div>
        </div>
      </div>
    </div>
